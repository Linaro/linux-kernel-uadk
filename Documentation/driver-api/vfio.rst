...
IOVA programmed into the assigned device, the guest needs to implement a flat
mapping for the IOVAs used by the host to map the physical doorbells, ie.
[0x8000000, 0x8100000]. This can be enforced by the VMM by exposing RMRs to
the guest.
