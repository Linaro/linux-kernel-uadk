...
void arm_smmu_sva_unbind(struct iommu_sva *handle)
{
	...
	/*
	 * The event queue does not need to be flushed since the device driver
	 * ensured all transaction are complete. For PRI however, although the
	 * device driver has stopped all DMA for this PASID, it may have left
	 * Page Requests in flight (if using the Stop Marker Message to stop
	 * PASID). Complete them.
	 */
